...
/**
 * Mount-based opacity + translate reveal. Content is visible by default: when
 * the reader prefers reduced motion the final state renders with no transition,
 * so nothing is ever stuck at opacity 0 or hidden from assistive tech.
 */
